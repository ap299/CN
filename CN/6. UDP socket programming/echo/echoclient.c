...
int main(int argc, char **argv)
{
	...
	char send_data[BUFFER]= "hi from client mayur"; // send buffer: hold information to send to server
	...
	sendto(sock,send_data,strlen(send_data),0, 	(struct sockaddr *) &remote_server, sockaddr_len); 
